...
import com.avit.common.http4.common.HttpHeader;
import com.avit.common.http4.exception.HttpProcessException;
import com.avit.common.http4.httpClient.HttpClientUtil;
	...
	public static void testMultiGet(HttpConfig cfg, int count) throws HttpProcessException{
	        try {
				...
				for(int i = 0; i< count;i++){
					if(count%10000==0){
						System.out.println("已经完成"+10000+"次请求");
					}
